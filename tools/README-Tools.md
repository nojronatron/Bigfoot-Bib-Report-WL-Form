...
- Aggregate the HTML, CSS, and JavaScript source files into a Template and Form file, ready for use in Winlink Express: `Build-InlineHtml.ps1`
...
5. Execute `Build-InlineHtml.ps1` to generate a single-file Winlink Form, encorporating HTML, CSS, and JavaScript from source files.
6. Test and debug the composed form.

## Deploy

1. Build the Form and Template using `Build-InlinkHtml.ps1`
...
```powershell
# preview only
pwsh -NoProfile -File tools/Build-InlineHtml.ps1 -DryRun

# produce output and backup to bak/
pwsh -NoProfile -File tools/Build-InlineHtml.ps1 -Backup -Validate
